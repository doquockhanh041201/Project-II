...
<section class="admin-content row space-between">
        ...
        <div class="header-top-left">
            <a href="index.php"><p> <span>Clothes with me</span></p></a>
        </div>
            <ul>
            <!-- <span style="color:blueviolet; font-size:22px"><?php echo Session::get('admin_name') ?></span> -->
                <li><a  href="#"> <img style="width:20px" src="icon/hi.png" alt="">Chào: Do Quoc Khanh <span style="color: red; font-size:20px">&#10084;</span></a>
